...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 5.155776708846315; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 3; // in; offset of the lateral wheel

    private Encoder leftEncoder, rightEncoder, frontEncoder;

    public static double X_MULTIPLIER = 0.9689393032; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.0084868399; // Multiplier in the Y direction
