...
public class BlueRight extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory traj1 = drive.trajectoryBuilder(startPose)
                .lineToLinearHeading(new Pose2d(16, 1, Math.toRadians(2)),
        ...
        Trajectory traj2 = drive.trajectoryBuilder(traj1.end())
                .lineToLinearHeading(new Pose2d(57, 0, Math.toRadians(2)),
        ...
        TrajectorySequence traj2_5 = drive.trajectorySequenceBuilder(traj2.end())
                .back(8)
                .lineToLinearHeading(new Pose2d(55, 1, Math.toRadians(-88)),
        ...
        Trajectory traj3 = drive.trajectoryBuilder(traj2_5.end())
                .lineToLinearHeading(new Pose2d(58, -16.5, Math.toRadians(-88)))
                .build();

        Trajectory traj4 = drive.trajectoryBuilder(traj3.end())
                .lineToLinearHeading(new Pose2d(54, -5, Math.toRadians(-88)),
        ...
        Trajectory traj6 = drive.trajectoryBuilder(traj5.end())
                .lineToLinearHeading(new Pose2d(55, 17, Math.toRadians(-88)))
                .build();
        ...
        Trajectory traj8 = drive.trajectoryBuilder(traj7.end())
                .lineToLinearHeading(new Pose2d(57, 17, Math.toRadians(-88)),
        ...
        Trajectory left = drive.trajectoryBuilder(traj11.end())
                .lineToLinearHeading(new Pose2d(56, 31.5, Math.toRadians(-88)),
                        SampleMecanumDrive.getVelocityConstraint(0.7 * DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(0.9 * DriveConstants.MAX_ACCEL))
                .build();

        Trajectory middle = drive.trajectoryBuilder(traj11.end())
                .lineToLinearHeading(new Pose2d(56, 7, Math.toRadians(-88)),
                        SampleMecanumDrive.getVelocityConstraint(0.7 * DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(0.9 * DriveConstants.MAX_ACCEL))
                .build();

        Trajectory right = drive.trajectoryBuilder(traj11.end())
                .lineToLinearHeading(new Pose2d(56, -16, Math.toRadians(-85)),
        ...
        if(tagOfInterest == null) {
            ...
            sleep(500);
            drive.moveSlidesAndTurret(2150, 0.7, -440, 0.3);
